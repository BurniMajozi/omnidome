...
const withPWA = require("@ducanh2912/next-pwa").default({
  ...
  runtimeCaching: [
    ...
    {
      urlPattern: /\.(?:eot|otf|ttf|ttc|woff|woff2|font\.css)$/i,
      handler: "StaleWhileRevalidate",
    ...
    },
    {
      ...
      options: { cacheName: "static-data-assets", expiration: { maxEntries: 32, maxAgeSeconds: 24 * 60 * 60 } },
    },
    {
      urlPattern: ({ url }) => {
...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_BRAND_PRIMARY_COLOR: process.env.BRAND_PRIMARY_COLOR || "#2563eb",
