    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-slate-900">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center h-14 w-14 rounded-2xl bg-emerald-500/20 mb-4">
            <Wrench size={28} className="text-emerald-400" />
          </div>
          <h1 className="text-2xl font-bold text-slate-100">
            {(brandConfig as any)?.appName || "OmniDome"}
          </h1>
          <p className="text-sm text-slate-400 mt-1">Field Sales Sign In</p>
        </div>
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2.5 rounded-lg border border-slate-600 bg-slate-900 text-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2.5 pr-10 rounded-lg border border-slate-600 bg-slate-900 text-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
                placeholder="••••••••"
              />
              <button
                type="button"
