"""Database session management for Web Analytics service."""
...
def init_tables() -> None:
    from services.web_analytics.models import PageAnalyticsBase
    engine = get_engine()
    PageAnalyticsBase.metadata.create_all(bind=engine)
