"""
OmniDome — Communication Hub UIX  [DEPRECATED]

This file served a self-contained vanilla HTML SPA from FastAPI.
It has been replaced by the React CommunicationModule component:

  apps/web/components/modules/communication-module.tsx
  apps/web/app/dashboard/comms/page.tsx  ← new standalone route

The new page is accessible at /dashboard/comms in the web admin app
and is linked from the sidebar "Communication" nav item.

Do NOT edit this file. It will be removed in a future cleanup pass.
"""
