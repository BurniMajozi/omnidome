...
# agent protocol design review

## Notes

Reviewed Google's developer guide to AI agent protocols and added OmniDome design mapping for MCP, A2A, UCP, AP2, A2UI, and AG-UI. No containers started.
