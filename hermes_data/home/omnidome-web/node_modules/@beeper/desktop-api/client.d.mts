...
import { Account, AccountListResponse, Accounts } from "./resources/accounts.mjs";
import { App, AppDownloadAssetParams, AppDownloadAssetResponse, AppOpenParams, AppOpenResponse, AppSearchParams, AppSearchResponse } from "./resources/app.mjs";
import { ContactSearchParams, ContactSearchResponse, Contacts } from "./resources/contacts.mjs";
import { MessageSearchParams, MessageSendParams, MessageSendResponse, Messages } from "./resources/messages.mjs";
import { RevokeRequest, Token, UserInfo } from "./resources/token.mjs";
import { Chat, ChatArchiveParams, ChatCreateParams, ChatCreateResponse, ChatRetrieveParams, ChatSearchParams, Chats, ChatsCursor } from "./resources/chats/chats.mjs";
 ...
 */
export declare class BeeperDesktop {
    #private;
    accessToken: string;
    baseURL: string;
    maxRetries: number;
     ...
     */
    constructor({ baseURL, accessToken, ...opts }?: ClientOptions);
    /**
    ...
    protected oauth2Auth(opts: FinalRequestOptions): Promise<NullableHeaders | undefined>;
    ...
    private buildBody;
    static BeeperDesktop: typeof BeeperDesktop;
    static DEFAULT_TIMEOUT: number;
    static BeeperDesktopError: typeof Errors.BeeperDesktopError;
...
export declare namespace BeeperDesktop {
    ...
    export { App as App, type AppDownloadAssetResponse as AppDownloadAssetResponse, type AppOpenResponse as AppOpenResponse, type AppSearchResponse as AppSearchResponse, type AppDownloadAssetParams as AppDownloadAssetParams, type AppOpenParams as AppOpenParams, type AppSearchParams as AppSearchParams, };
    export { Contacts as Contacts, type ContactSearchResponse as ContactSearchResponse, type ContactSearchParams as ContactSearchParams, };
    export { Chats as Chats, type Chat as Chat, type ChatCreateResponse as ChatCreateResponse, type ChatsCursor as ChatsCursor, type ChatCreateParams as ChatCreateParams, type ChatRetrieveParams as ChatRetrieveParams, type ChatArchiveParams as ChatArchiveParams, type ChatSearchParams as ChatSearchParams, };
    export { Messages as Messages, type MessageSendResponse as MessageSendResponse, type MessageSearchParams as MessageSearchParams, type MessageSendParams as MessageSendParams, };
