...
var _BeeperDesktop_instances, _a, _BeeperDesktop_encoder, _BeeperDesktop_baseURLOverridden;
Object.defineProperty(exports, "__esModule", { value: true });
exports.BeeperDesktop = void 0;
...
const accounts_1 = require("./resources/accounts.js");
const app_1 = require("./resources/app.js");
const contacts_1 = require("./resources/contacts.js");
const messages_1 = require("./resources/messages.js");
const token_1 = require("./resources/token.js");
const chats_1 = require("./resources/chats/chats.js");
...
class BeeperDesktop {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('BEEPER_DESKTOP_BASE_URL'), accessToken = (0, env_1.readEnv)('BEEPER_ACCESS_TOKEN'), ...opts } = {}) {
        _BeeperDesktop_instances.add(this);
        _BeeperDesktop_encoder.set(this, void 0);
        /**
         * Accounts operations
         */
         ...
         * Contacts operations
         */
        this.contacts = new API.Contacts(this);
        /**
         * Chats operations
         */
        this.chats = new API.Chats(this);
        /**
         * Messages operations
         */
        ...
        if (accessToken === undefined) {
            throw new Errors.BeeperDesktopError("The BEEPER_ACCESS_TOKEN environment variable is missing or empty; either provide it, or instantiate the BeeperDesktop client with an accessToken option, like new BeeperDesktop({ accessToken: 'My Access Token' }).");
        }
        const options = {
            accessToken,
            ...opts,
        ...
        this.timeout = options.timeout ?? _a.DEFAULT_TIMEOUT /* 30 seconds */;
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('BEEPER_DESKTOP_LOG'), "process.env['BEEPER_DESKTOP_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _BeeperDesktop_encoder, Opts.FallbackEncoder, "f");
    ...
    async authHeaders(opts) {
        return (0, headers_1.buildHeaders)([await this.bearerAuth(opts), await this.oauth2Auth(opts)]);
    }
    async bearerAuth(opts) {
        return (0, headers_1.buildHeaders)([{ Authorization: `Bearer ${this.accessToken}` }]);
    }
    async oauth2Auth(opts) {
        return undefined;
    }
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _BeeperDesktop_instances, "m", _BeeperDesktop_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _BeeperDesktop_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.BeeperDesktop = BeeperDesktop;
_a = BeeperDesktop, _BeeperDesktop_encoder = new WeakMap(), _BeeperDesktop_instances = new WeakSet(), _BeeperDesktop_baseURLOverridden = function _BeeperDesktop_baseURLOverridden() {
    return this.baseURL !== 'http://localhost:23373';
};
BeeperDesktop.BeeperDesktop = _a;
BeeperDesktop.DEFAULT_TIMEOUT = 30000; // 30 seconds
BeeperDesktop.BeeperDesktopError = Errors.BeeperDesktopError;
BeeperDesktop.APIError = Errors.APIError;
BeeperDesktop.APIConnectionError = Errors.APIConnectionError;
BeeperDesktop.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
BeeperDesktop.APIUserAbortError = Errors.APIUserAbortError;
BeeperDesktop.NotFoundError = Errors.NotFoundError;
BeeperDesktop.ConflictError = Errors.ConflictError;
BeeperDesktop.RateLimitError = Errors.RateLimitError;
BeeperDesktop.BadRequestError = Errors.BadRequestError;
BeeperDesktop.AuthenticationError = Errors.AuthenticationError;
BeeperDesktop.InternalServerError = Errors.InternalServerError;
BeeperDesktop.PermissionDeniedError = Errors.PermissionDeniedError;
BeeperDesktop.UnprocessableEntityError = Errors.UnprocessableEntityError;
BeeperDesktop.toFile = Uploads.toFile;
BeeperDesktop.Accounts = accounts_1.Accounts;
BeeperDesktop.App = app_1.App;
BeeperDesktop.Contacts = contacts_1.Contacts;
BeeperDesktop.Chats = chats_1.Chats;
BeeperDesktop.Messages = messages_1.Messages;
BeeperDesktop.Token = token_1.Token;
