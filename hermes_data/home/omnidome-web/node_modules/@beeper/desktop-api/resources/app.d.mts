 ...
 * App operations
 */
export declare class App extends APIResource {
    /**
     ...
     * ```
     */
    downloadAsset(body: AppDownloadAssetParams, options?: RequestOptions): APIPromise<AppDownloadAssetResponse>;
    /**
...
export declare namespace AppSearchResponse {
    interface Results {
        /**
         * Top chat results.
         */
...
export declare namespace App {
    export { type AppDownloadAssetResponse as AppDownloadAssetResponse, type AppOpenResponse as AppOpenResponse, type AppSearchResponse as AppSearchResponse, type AppDownloadAssetParams as AppDownloadAssetParams, type AppOpenParams as AppOpenParams, type AppSearchParams as AppSearchParams, };
}
