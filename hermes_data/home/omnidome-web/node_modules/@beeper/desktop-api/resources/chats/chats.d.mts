...
import * as RemindersAPI from "./reminders.mjs";
import { ReminderCreateParams, ReminderDeleteParams, Reminders } from "./reminders.mjs";
...
export declare class Chats extends APIResource {
     ...
     * ```
     */
    search(query?: ChatSearchParams | null | undefined, options?: RequestOptions): PagePromise<ChatsCursor, Chat>;
}
...
export declare namespace Chats {
    export { type Chat as Chat, type ChatCreateResponse as ChatCreateResponse, type ChatsCursor as ChatsCursor, type ChatCreateParams as ChatCreateParams, type ChatRetrieveParams as ChatRetrieveParams, type ChatArchiveParams as ChatArchiveParams, type ChatSearchParams as ChatSearchParams, };
    export { Reminders as Reminders, type ReminderCreateParams as ReminderCreateParams, type ReminderDeleteParams as ReminderDeleteParams, };
}
