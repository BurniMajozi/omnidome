 ...
 */
export declare class Reminders extends APIResource {
    /**
...
export declare namespace ReminderCreateParams {
    /**
     * Reminder configuration
     */
    interface Reminder {
...
export declare namespace Reminders {
    export { type ReminderCreateParams as ReminderCreateParams, type ReminderDeleteParams as ReminderDeleteParams, };
}
